...
<body>
    <div class="flex-container">
        ...
        <div class="homepage1">
            <p><strong>Welcome!</strong> We are Uppal Transport. We specialize in the transportation of goods.</p>
        </div>
        <div class="homepage2">
            <p>We provide owner operators loads all across United States. We have loads for temperature controlled trailers (reefer) and dry van. We also hire drivers, team or solo, to drive our company trucks from CA to East Coast or Mid West.</p>
            <p>We provide owner operators loads all across United States. We have loads for temperature controlled trailers (reefer) and dry van. We also hire drivers, team or solo, to drive our company trucks from CA to East Coast or Mid West. To use our serves you can send us an email through either your personal computer, laptop, phone etc...</p>
        </div>
        <div class="paragraph">
